...
public class HelloSpringApp {
	...
	//1- This example illustrates the DI for literal values in Spring by Properties file
	//A- Create a propertiesfile
	//B- add the property file placeholder to config
	//		<context:property-placeholder location="classpath:sport.properties"/>

	//C- Then we add the DI to XML file inside the CricketCoach as a property
	//	<bean id="basketballCoach"
	//			class="com.ghassan.springdemo.basketballCoach">
	//			 			<!-- Set up Setter injection -->
	//			 <property name = "The setter method name without _set_"  value="${propertyName}"> </property
	//	</bean>
	//
