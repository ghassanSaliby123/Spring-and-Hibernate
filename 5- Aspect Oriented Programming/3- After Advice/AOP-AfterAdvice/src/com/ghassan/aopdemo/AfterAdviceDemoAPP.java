...
public class AfterAdviceDemoAPP {
	...
	//After advice @After:
	//- This type of advice is called after the execution of the method in case of success or failure
	// 	@After(pointcut)-->the result which is returned by the method
